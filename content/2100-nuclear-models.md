...
:align: center
:name: two-center-correlations
:width: 300px

Neutron level scheme of the two-center shell-model as a function of the deformation eccentricity {math}`z_0`. The y-axis intercepts correspond to spherical shell-model states, whilst at large separations the spherical shell-model states of the fragments are indicated {cite:ps}`scharnweber_asymptotically_1970`. 
:::
